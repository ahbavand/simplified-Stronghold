...
import projeh.Client;
import projeh.Map;
import projeh.Panel2;
import projeh.Store;

public class ChooseMap extends JFrame implements ActionListener {
	...
	public ChooseMap(int countrynumber,Client client) {
		this.client=client;
		ChooseMap.countrynumber=countrynumber;
