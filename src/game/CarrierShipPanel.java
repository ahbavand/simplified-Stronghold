...
public class CarrierShipPanel  extends JPanel implements Runnable  {
	...
	public CarrierShipPanel(boolean display,Integer woodSize,Integer ironSize,Integer health) {
